...
export default function Terms() {
  return (
    <LegalPage title="Kullanım Koşulları" updatedAt="18 Nisan 2026">
      <P>
        Nar Aura uygulamasını kullanarak aşağıdaki koşulları kabul etmiş olursun. Bu koşullara
      ...
      <P>
        ...
        aldığın kararların sonuçlarından Nar Aura sorumlu tutulamaz.
      </P>
      ...
      <H>Nar Aura Premium aboneliği</H>
      <P>
